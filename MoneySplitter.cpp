...
public:
    ...
    // Continuously prompt until valid input is provided
        ...
        if(choice==1){
            ...
            string r=name+" owes you " + to_string(amt);
...
//made it seperate cuz data dono ka diff tha
    void markOffOwesAsPaid(string eventName){ //you owe others
        strNode* trav=eventSingleNameOwes.head; //enent ka name
        ...
        while(trav!=NULL ){
            if(trav->data==eventName){
                ...
                string paying="Event: "+eventName+", where you owed "; //str conc
                trav=trav->next;
                ...
                paid.push(paying); // sentence push view paid exenses main order main aa jae k app kis person ko kitni amount owe krty hain
            ...
            remindOwes.dequeue();  // pay kr dia hai tou wo expense deque ho jae ga ta k display main wo amount humary pass display na ho
        }
    }
    ...
    void displaySingleExpenses(){
        ...
        //latest first used stacks for this
        //oldest k liye ll
        //lowest to highest bubble sort
    ...
    void charity(){
        ...
        if(pickk==1){
            cout<<"What amount would you like to donate to charity?";
            int percentageChar;
        cin >> percentageChar;
